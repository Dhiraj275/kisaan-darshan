    ...
    return (
        <>
            <div className="d-flex justify-content-center">
                <select name="state" className="inputs-reg" onChange={changeState} id="inputState">
            ...
            <div className="d-flex justify-content-center">
                {
                    props.formData.state === undefined ? <select disabled name="district" onChange={props.handleFormChanges} className="inputs-reg" id="inputDistrict">
                        <option value="">Select a State First</option>
                    </select>
                        : <select name="district" onChange={props.handleFormChanges} className="inputs-reg" id="inputDistrict">
                            <option value="">Select a State First</option>
                        </select>
                }
            </div>
